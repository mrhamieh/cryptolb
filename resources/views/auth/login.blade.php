            ...
            <div class="login-form login-signin" id="kt_login_signin_form">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus/>
                        @error('email')
